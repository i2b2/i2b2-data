INSERT INTO QT_QUERY_RESULT_TYPE (result_type_id, name, description, display_type_id, visual_attribute_type_id, user_role_cd, classname) VALUES (14, 'PATIENT_CHARLSON_XML', 'Charlson Comorbid Conditions', 'CATNUM', 'LA', null, 'edu.harvard.i2b2.crc.dao.setfinder.QueryResultGenerator');
INSERT INTO QT_QUERY_RESULT_TYPE (result_type_id, name, description, display_type_id, visual_attribute_type_id, user_role_cd, classname) VALUES (15, 'PATIENT_HISTORICAL_DATA_XML', 'Historical Visit Count', 'CATNUM', 'LA', null, 'edu.harvard.i2b2.crc.dao.setfinder.QueryResultGenerator');
INSERT INTO QT_QUERY_RESULT_TYPE (result_type_id, name, description, display_type_id, visual_attribute_type_id, user_role_cd, classname) VALUES (16, 'PATIENT_COMMON_LAB_XML', 'Patients Ever Having Common Labs', 'CATNUM', 'LA', null, 'edu.harvard.i2b2.crc.dao.setfinder.QueryResultGenerator');
