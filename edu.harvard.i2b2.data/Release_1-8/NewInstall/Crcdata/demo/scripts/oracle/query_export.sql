...
The i2b2 Team </Letter>
  <Table>
	...
	<Query>SELECT   to_char(a.PATIENT_NUM) as "i2b2 Patient Number"
...
The i2b2 Team 
  ...
  <Table>
	...
	<Query>SELECT distinct   to_char(a.PATIENT_NUM) as "i2b2 Patient Number"
