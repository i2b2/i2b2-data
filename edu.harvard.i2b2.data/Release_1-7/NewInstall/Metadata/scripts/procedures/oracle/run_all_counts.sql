...
BEGIN
 ...
 PAT_COUNT_VISITS( dis_c_table_name , observationTable ,errorMsg  );
 PAT_COUNT_DIMENSIONS( dis_c_table_name , observationTable ,  'concept_cd', 'concept_dimension', 'concept_path', errorMsg  );
 PAT_COUNT_DIMENSIONS( dis_c_table_name , observationTable ,  'provider_id', 'provider_dimension', 'provider_path', errorMsg  );
 PAT_COUNT_DIMENSIONS( dis_c_table_name , observationTable ,  'modifier_cd', 'modifier_dimension', 'modifier_path', errorMsg  );
