...
CREATE TABLE ACT_COVID_V41_OMOP (
        ...
        C_SYMBOL                              VARCHAR2(50)    NULL,
         	OMOP_NS_CONCEPT_ID           VARCHAR2(50), 
    OMOP_S_CONCEPT_ID           VARCHAR2(50), 
	I2B2_ACT_BASECODE           VARCHAR2(50),
	TRANSLATION_RULE VARCHAR2(300)
)
;
...
CREATE TABLE ACT_LOINC_LAB_V4_OMOP (
        C_HLEVEL                              NUMBER(22,0)    NOT NULL,
        C_FULLNAME                    VARCHAR2(700)   NOT NULL,
        C_NAME                                VARCHAR2(2000)  NOT NULL,
        C_SYNONYM_CD                  CHAR(1) NOT NULL,
...
CREATE TABLE ACT_ICD9CM_PX_V4_OMOP (
        C_HLEVEL                              NUMBER(22,0)    NOT NULL,
        C_FULLNAME                    VARCHAR2(700)   NOT NULL,
        C_NAME                                VARCHAR2(2000)  NOT NULL,
        C_SYNONYM_CD                  CHAR(1) NOT NULL,
...
CREATE TABLE ACT_ICD9CM_DX_V4_OMOP (
        C_HLEVEL                              NUMBER(22,0)    NOT NULL,
        C_FULLNAME                    VARCHAR2(700)   NOT NULL,
        C_NAME                                VARCHAR2(2000)  NOT NULL,
        C_SYNONYM_CD                  CHAR(1) NOT NULL,
...
CREATE TABLE ACT_ICD10_ICD9_DX_V4_OMOP (
        C_HLEVEL                              NUMBER(22,0)    NOT NULL,
        C_FULLNAME                    VARCHAR2(700)   NOT NULL,
        C_NAME                                VARCHAR2(2000)  NOT NULL,
        C_SYNONYM_CD                  CHAR(1) NOT NULL,
...
CREATE TABLE ACT_VITAL_SIGNS_V4_OMOP (
        C_HLEVEL                              NUMBER(22,0)    NOT NULL,
        C_FULLNAME                    VARCHAR2(700)   NOT NULL,
        C_NAME                                VARCHAR2(2000)  NOT NULL,
        C_SYNONYM_CD                  CHAR(1) NOT NULL,
