    ...
    WHEN NO_DATA_FOUND THEN
        existingEncounterNum := null;
                ...
                if existingEncounterNum is not  null then 
                    ...
                    values($1,''HIVE'',$2,''HIVE'',$3,''P'',''A'',Now(),Now(),Now(),''edu.harvard.i2b2.crc'')' using maxEncounterNum,maxEncounterNum,maxEncounterNum,disPatiendId,disPatiendIdSource;
...
and temp.patient_ide_source  =	encounter_mapping.patient_map_id_source
