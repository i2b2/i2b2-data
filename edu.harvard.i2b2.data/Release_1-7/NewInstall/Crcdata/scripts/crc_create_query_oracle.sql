...
;
insert into QT_QUERY_RESULT_TYPE(RESULT_TYPE_ID,NAME,USER_ROLE_CD,DESCRIPTION,DISPLAY_TYPE_ID,VISUAL_ATTRIBUTE_TYPE_ID) values(11,'PATIENT_TOP50MEDS_XML','DATA_LDS','Top 50 medications breakdown','CATNUM','LA')
;
insert into QT_QUERY_RESULT_TYPE(RESULT_TYPE_ID,NAME,USER_ROLE_CD,DESCRIPTION,DISPLAY_TYPE_ID,VISUAL_ATTRIBUTE_TYPE_ID) values(12,'PATIENT_TOP50DIAG_XML','DATA_LDS','Top 50 diagnoses breakdown','CATNUM','LA')
;
...
;
insert into QT_QUERY_RESULT_TYPE(RESULT_TYPE_ID,NAME,USER_ROLE_CD,DESCRIPTION,DISPLAY_TYPE_ID,VISUAL_ATTRIBUTE_TYPE_ID) values(14,'ADMIN_RUNNING_QUERY_XML','ADMIN','List of running queries in last 7 days','CATNUM','LH')
;
insert into QT_QUERY_RESULT_TYPE(RESULT_TYPE_ID,NAME,USER_ROLE_CD,DESCRIPTION,DISPLAY_TYPE_ID,VISUAL_ATTRIBUTE_TYPE_ID) values(15,'ADMIN_QUERY_TIME_XML','ADMIN','Time distribution for run queries','CATNUM','LH')
;
insert into QT_QUERY_RESULT_TYPE(RESULT_TYPE_ID,NAME,USER_ROLE_CD,DESCRIPTION,DISPLAY_TYPE_ID,VISUAL_ATTRIBUTE_TYPE_ID) values(16,'ADMIN_QUERY_BY_USER_XML','ADMIN','List of queries run by users in last year','CATNUM','LH')
;
insert into QT_QUERY_RESULT_TYPE(RESULT_TYPE_ID,NAME,USER_ROLE_CD,DESCRIPTION,DISPLAY_TYPE_ID,VISUAL_ATTRIBUTE_TYPE_ID) values(17,'ADMIN_RUN_QUERY_XML','ADMIN','Month breakdown of number of queries run','CATNUM','LH')
;
