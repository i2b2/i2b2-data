...
FROM            (SELECT        visit_occurrence_id AS ENCOUNTER_NUM, person_id AS PATIENT_NUM, CAST(condition_source_concept_id AS varchar(50)) AS CONCEPT_CD, nvl(CAST(provider_id AS VARCHAR(50)),'@') AS PROVIDER_ID, 
                          ...
                          UNION
                          SELECT        visit_occurrence_id AS ENCOUNTER_NUM, person_id AS PATIENT_NUM, CAST(drug_source_concept_id AS varchar(50)) AS CONCEPT_CD, nvl(CAST(provider_id AS VARCHAR(50)),'@') AS PROVIDER_ID, 
                          ...
                          FROM            DRUG_EXPOSURE
                          UNION
                          SELECT        visit_occurrence_id AS ENCOUNTER_NUM, person_id AS PATIENT_NUM, CAST(procedure_source_concept_id AS varchar(50)) AS CONCEPT_CD,  nvl(CAST(provider_id AS VARCHAR(50)),'@')  AS PROVIDER_ID, 
                          ...
                          UNION
                          SELECT        visit_occurrence_id AS ENCOUNTER_NUM, person_id AS PATIENT_NUM, CAST(device_source_concept_id AS varchar(50)) AS CONCEPT_CD, nvl(CAST(provider_id AS VARCHAR(50)),'@')  AS PROVIDER_ID, 
                          ...
                          UNION
                          SELECT        visit_occurrence_id AS ENCOUNTER_NUM, person_id AS PATIENT_NUM, CAST(measurement_source_concept_id AS varchar(50)) AS CONCEPT_CD,  nvl(CAST(provider_id AS VARCHAR(50)),'@')  AS PROVIDER_ID, 
                          ...
                          FROM            MEASUREMENT
                          UNION
                          SELECT        visit_occurrence_id AS ENCOUNTER_NUM, person_id AS PATIENT_NUM, CAST(observation_source_concept_id AS VARCHAR(50)) AS CONCEPT_CD, nvl(CAST(provider_id AS VARCHAR(50)),'@')  AS PROVIDER_ID, 
...
(YEAR_OF_BIRTH||'-'|| MONTH_OF_BIRTH||'-'||day_of_birth)AS BIRTH_DATE,
cast (null as date) AS DEATH_DATE, to_char(gender_concept_id) AS SEX_CD,
ceil((((cast(sysdate as date) - cast(birth_datetime as date)) * 24)/8766)) AS AGE_IN_YEARS_NUM,
NULL AS LANGUAGE_CD,
to_char(RACE_CONCEPT_ID) AS RACE_CD,
NULL AS MARITAL_STATUS_CD,
						 NULL AS RELIGION_CD, NULL AS ZIP_CD, NULL AS STATECITYZIP_PATH, NULL AS INCOME_CD, NULL 
                         AS PATIENT_BLOB,
                         CAST(NULL AS DATE) AS UPDATE_DATE, CAST(NULL AS DATE) AS DOWNLOAD_DATE,
                         CAST(NULL AS DATE)  AS IMPORT_DATE,
                         NULL AS SOURCESYSTEM_CD, NULL AS UPLOAD_ID,
                      to_char( ethnicity_concept_id) AS ETHNICITY_CD
FROM            PERSON;
...
SELECT  
            ...
            nvl(CAST(provider_id AS VARCHAR(50)),'@')  AS PROVIDER_ID, 
...
SELECT 
            ...
            CAST(device_type_concept_id AS VARCHAR2(50)) AS MODIFIER_CD,
            1 AS INSTANCE_NUM,
            NULL AS valtype_cd,
            NULL AS location_cd,
            NULL AS tval_char,
...
SELECT 
            ...
            nvl(CAST(provider_id AS VARCHAR(50)),'@')  AS PROVIDER_ID, 
   			device_exposure_start_datetime AS START_DATE, 
			device_exposure_end_datetime AS END_DATE, 
           CAST(device_type_concept_id AS VARCHAR(50)) AS MODIFIER_CD,
            1 AS INSTANCE_NUM,
            NULL AS valtype_cd,
            NULL AS location_cd,
            NULL AS tval_char,
